    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 top-1/2 flex  items-start justify-start overflow-hidden  rounded-2xl  border border-white/[0.1] bg-theme-light p-4 shadow-[0_8px_16px] shadow-theme-light transition duration-700 group-hover/pin:border-white/[0.2]"
        >
      ...
      <div className=" inset-0 -mt-7 h-full w-full  flex-none">
        <div className="absolute inset-x-0 top-0  flex justify-center">
          <Link
            href={href}
            target={"_blank"}
            className="relative z-10 flex items-center space-x-2 rounded-full bg-theme-dark px-4 py-0.5 ring-1 ring-white/10 "
          >
            <span className="relative z-20 inline-block py-0.5 text-lg font-bold text-white">
              {title}
            </span>

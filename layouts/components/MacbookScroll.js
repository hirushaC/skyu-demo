...
const MacbookScroll = ({ src, showGradient, title, subtitle, badge }) => {
  ...
  return (
    <div
      ref={ref}
      className="flex flex-shrink-0 transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-100 lg:scale-150 md:py-80"
    >
      <motion.div
        style={{
        ...
        className=" mb-20 text-center text-neutral-800"
      >
        <h2 className="text-white">
          SkyU For
          <span className="text-primary"> {title}</span>
        </h2>
        <p className="my-2 text-sm font-normal text-[#878B9E]">{subtitle}</p>
        <div className="mt-6 text-xs font-medium">
          <Link className="btn btn-primary px-5" href="/contact">
            Learn more
          </Link>
        </div>
      </motion.div>
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      <motion.div
        ...
        className="absolute inset-0 h-96 w-[32rem] rounded-2xl border p-2"
      >
